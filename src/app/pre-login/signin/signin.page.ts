...
export class SigninPage implements OnInit {
  ...
  dummyData: any = {
    header: {
      BankCode: "Tv2MMUOL4J1pBugUYzIEN3Yd+tohEUrKjMrccWS/er9sjrTaJ9uTLudIL7ez1B6hfM78uPJd6FHh\noHHgOhsY7W5KTSxLfpS+iGHCAG21BhiLRMIPfhXt3qSHi9vJhitTVEmEZrJDDe67i5A9f9WXK8r/\nIlJQKbf3JDB1niDxu1g=\n",
      Channel: "GozvA0cKwVcnt3W3zGDGl+cge6FGnWs7LgegaL/MQfBf8NoiujLVam7sFPW3SNxIWrEfeQld+1/Q\nBfTYM+gi+NUQk7637PXB6bzY4pHbv8orUIPT0CQVyCVrQGKhROaL1vyGaE3k2V1xCwSaZ799zzql\nBh2K92dCoB63kj/hoYc=\n",
      customerInfo: {
        customerId: "vddRBMkCGzp6F3mayHlUhqyplO3UqALjVNiVcEBPaTN0qaY4DQ71hw+QoG+ZqIkBTamoFEW0CsUv\ngioEHESQQcVloY50q5PDS9SM0R65Lq27S8PxTAfd5zEQBPEMSketHaA6/upAlRsUh5A4UIbYI3Qk\nEFZTwEZ4L6KUUDhJwCo=\n",
        mobileNo: "eWDmBfchOOmUO1xHtYVJOWcoC9J3winGAgWShWM2MsFsIK+Iy+fCNcHP/2MJt10evLI80Rsg3fsZ\nYC3Mp/aGgOTn6GEHpvIFIGsbUW3LUw9VZ3Tw9f/yZiCGFUWGt2DlmXNFkOwze5tHN865mPvPeSEK\nb4KLglRQmBCg9K8eXj4=\n",
        upitoken: "kKwc6l9TJM6xnJ+LIT1XpUHDaZgVpAREKLECFUdVuzCIcSemi5i9lpBoc4KRkWeXO49HR9osLXET\nIoONmc/oEb5fjjcc0f3oFljOU2rtoFmVQCsLLDOu5jZZf86/HRnSi/6q4UF8p6Z0jh/3DjnL3YkA\nFA0237P97dWGvo9Lbd8=\n",
        sessionId: "X/Hl1rFCKfmOvCQAbRcDbtSs+Jv3ZyR/4WoPNnMsLuwy/+BYXV9zAQRKiCUDtP7WpwJnhBNh+yy4\n/gjc96hNfpiJ6G8zAWeRPzJe/ramHZcWmLgoLBUiSbt2v+wPcbBlnunvlugxe5atHLrluixMwCN4\nu73f7tvcOyq6tMOZU3U=\n",
        profileId: "eyxzAbyY7K0Kke8aDKar3fVFJXWjxDMB1aMFx7NHN+c1Xx4RHxuNLYJwDZSYmdYUwhBSwO83IxEg\nVrKvfh6vUSIpVN9qlTo+Cpb/IyXuHyG3Lr3tP3sx0wDoBJh64ENz+CJX7zMxgEsuUlai7dcqEqMh\nWsjqpiik+SDz6W8lFec=\n",
        token: ""
      },
      deviceInfo: {
        geocode: "g8OBYBCFWxxrrG7TptEUmfALSEcjcBr7H7CnCM15wzXNlctJazix06blw7TsCr+WXhplppLZEiEO\nWgKOEYVo/XKDjdM73F0w+8UH0X5IGfd03yaRWmtXi24+ol0Wmf3+Sl0jFmrvI4GwG2oh2OQTyQ0F\nqjiLlJkV53NDXHQJhQE=\n",
        location: "Sgh75Ia4dE2LReGoyLFAMzQ+egnptogU66NKW5nWAnP/ABK6OzcWbzkk782V9r3i3Mzex4DUonfW\nwhp76mE/lnaDYBUjxmztqJ9X5C3o5E+OnvCLY9qKU7IsGmuoulzE9q4VSDvY6oe74Ky3EAnAu5GU\nhIKrFDtBZZ+IXUk7p0g=\n",
        ...
        capability: "XMvX24JYNOEPKTyqz5Ra4YQGpEDHK3tgDecT6aiOtXR8QDpsjmrKgks0g6n8lTYqEQ7bGyf0//Rz\nvFuQL7eztDI54waB11WhDHjEFdSoti0JyIuTYBJKGkHDabw4bss2+tw0L21e6AQucOymt7KNEHHO\nVqgaiwCbmdLYj1ONLNs=\n",
        telecom: "FdvQ6w2g53HCn2YPOSnf40MyV8vT/9+7Bw1W9z1BHdPH48LBvyg2Fot2qc8wTslKuricpNBVNhFa\nE8CIkDXbmAZY1BuOVKU++P92we6n7kQ9OCSjte4Rw5oJ9nK70rQb4XnNr2vfa3L8fQfy9Ipr8I+p\neMK7DSJtFRToFxeQqUE=\n"
      }
    },
    transactionInfo: {
      ...
      attributes: {
        fcmtoken: "eDiS-LOZRvuKpTubN03wri:APA91bFqePhOopkVL_Gb4hkcQvcOB4ceVWc5RtvWqlJ1F5wvZTnyCOkhVDwKjZ6jheaYYLF-yVpzHeHLA553ZBj4tFIsCK9W15x6DkfDXzxinbL7naowDv8",
        apin: "131995",
        issubmerchant: "0",
  ...
  async logIn() {
    ...
    const dmyData = JSON.stringify(this.dummyData);
    var attributes: any = null;
    attributes = {
      fcmtoken: '318E26474E0C40FEAD92275A273256EF555D972BF0ADE1CC2731D0BCA9E68C312E6983BBED8EBE4371B9058DB911D251BD23DECB8F64F8C47614A0494248B7570FC3C021838E3B8D9E72F9E13DEF5E55E189AC6011CFC963D1FD77639FEC1B3B',
      apin: '123456',
      issubmerchant: 'hello',
      subMerchantMobno: "918051337788"
    }
